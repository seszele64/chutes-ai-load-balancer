# ADDED: API Structured Responses
...
| Document | Location |
|----------|----------|
| Proposal | `openspec/changes/api-structured-responses/proposal.md` |
| Design | `openspec/changes/api-structured-responses/design.md` |
| Tasks | `openspec/changes/api-structured-responses/tasks.md` |
